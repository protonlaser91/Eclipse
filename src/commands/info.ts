    ...
    async runCommand(args: string[], msg: Discord.Message, Bot: Discord.Client): Promise<void> {
        ...
        if (troop.includes("thanos")){
            ...
            var loot = 3
                ...
                var img = `REDACT`
                var desc = "The REDACT troop is insanely powerful! It can obliterate hordes of saimonGays and is a primary attack troop only offset by its cost. It is able to loot insanely, travels fast, and causes utmost destruction. It does not have good defense stats, however! \n\nREDACT does not do well with Thanosid or anumonGamers due to their special attacks. It is still a very powerful troop!";
                var price = 200
                var speed = 4
                var loot = 40
        }
